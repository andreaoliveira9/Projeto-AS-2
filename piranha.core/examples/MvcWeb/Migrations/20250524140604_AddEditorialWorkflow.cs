        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CommentTemplate = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    RequiresComment = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    AllowedRoles = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true, defaultValue: "[]"),
                    SortOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: true),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransitionRules_WorkflowStates_FromStateId",
                        column: x => x.FromStateId,
                        principalTable: "WorkflowStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransitionRules_WorkflowStates_ToStateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkflowDefinitionId1 = table.Column<Guid>(type: "TEXT", nullable: true),
                    WorkflowStateId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowInstances_WorkflowStates_WorkflowStateId",
            ...
            migrationBuilder.CreateTable(
                name: "WorkflowContentExtensions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ContentId = table.Column<string>(type: "TEXT", nullable: false),
                    ...
                    IsInWorkflow = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    LastWorkflowState = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Created = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastModified = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkflowContentExtensions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkflowContentExtensions_WorkflowInstances_CurrentWorkflowInstanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransitionRules_FromStateId",
                table: "TransitionRules",
                column: "FromStateId");

            migrationBuilder.CreateIndex(
                name: "IX_TransitionRules_ToStateId",
                table: "TransitionRules",
                column: "ToStateId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowContentExtensions_CurrentWorkflowInstanceId",
                table: "WorkflowContentExtensions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowInstances_WorkflowStateId",
                table: "WorkflowInstances",
