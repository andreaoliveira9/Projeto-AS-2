...
{
    [DbContext(typeof(CustomSQLiteDb))]
    partial class CustomSQLiteDbModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Piranha.Data.EditorialWorkflow.WorkflowContentExtension", b =>
                {
                    ...
                    b.ToTable("WorkflowContentExtensions");
                });
            ...
            modelBuilder.Entity("Piranha.Data.EditorialWorkflow.WorkflowInstance", b =>
                {
                    ...
                    b.HasOne("Piranha.Data.EditorialWorkflow.WorkflowDefinition", null)
                        .WithMany("Instances")
                        .HasForeignKey("WorkflowDefinitionId1");

                    b.HasOne("Piranha.Data.EditorialWorkflow.WorkflowState", null)
